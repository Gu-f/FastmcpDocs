...
For more complex tool transformations, see [Transforming Tools](/en/patterns/tool-transformation).
...
Clients can handle these notifications using a [message handler](/en/clients/messages) to automatically refresh their tool lists or update their interfaces.
