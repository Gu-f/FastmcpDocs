...
[Transforms](/en/servers/transforms/transforms) modify components as they flow from providers to clients. Each transform sits in a chain, intercepting queries and modifying results before passing them along.
...
Transforms can be added to individual providers (affecting just that source) or to the server itself (affecting all components). See [Transforms](/en/servers/transforms/transforms) for the full picture.
...
- [Mount another server](/en/servers/composition) into yours
- [Proxy a remote server](/en/servers/providers/proxy) through yours
- [Control visibility state](/en/servers/visibility) of components
- [Build dynamic sources](/en/servers/providers/custom) like database-backed tools

## Next Steps

- [Local](/en/servers/providers/local) - How decorators work
- [Mounting](/en/servers/composition) - Compose servers together
- [Proxying](/en/servers/providers/proxy) - Connect to remote servers
- [Transforms](/en/servers/transforms/transforms) - Namespace, rename, and modify components
- [Visibility](/en/servers/visibility) - Control which components clients can access
- [Custom](/en/servers/providers/custom) - Build your own providers
