...
For more complex web applications, consider [mounting your MCP server into a FastAPI or Starlette app](/en/deployment/self-hosted#integration-with-web-frameworks).
