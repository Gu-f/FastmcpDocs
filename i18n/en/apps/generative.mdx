...
- **[Interactive Tools](/en/apps/prefab)** — the component building blocks the LLM will use
- **[Prefab component reference](https://prefab.prefect.io/docs/components)** — full component library
- **[Development](/en/apps/development)** — preview generative tools locally with `fastmcp dev apps`
