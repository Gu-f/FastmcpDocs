...
- **[FastMCPApp](/en/apps/fastmcp-app)** — when your UI needs to call backend tools (forms, search, CRUD)
- **[Generative UI](/en/apps/generative)** — let the LLM design the UI at runtime
- **[Custom HTML](/en/apps/low-level)** — when Prefab isn't enough (maps, 3D, your own framework)
- **[Examples](/en/apps/examples)** — complete working servers you can run today
- **[Development](/en/apps/development)** — preview your tools locally with `fastmcp dev apps`
