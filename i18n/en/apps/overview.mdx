...
import PrefabPinWarning from '/en/snippets/prefab-pin-warning.mdx'
import { PrefabDemoFrame } from '/en/snippets/prefab-demo-frame.mdx'
...
### [Interactive Tools](/en/apps/prefab) — start here
...
### [FastMCPApp](/en/apps/fastmcp-app) — when the UI calls back to the server
...
### [Generative UI](/en/apps/generative) — when the LLM writes the UI
...
### [Custom HTML](/en/apps/low-level) — when you need full control
...
- **[Quickstart](/en/apps/quickstart)** — build a working app in a minute
- **[Examples](/en/apps/examples)** — complete working servers you can run today
- **[Providers](/en/apps/providers/approval)** — ready-made capabilities (approvals, choice pickers, file upload, forms) you add with one line
- **[Development](/en/apps/development)** — preview app tools locally with `fastmcp dev apps`
