...
- **[Interactive Tools](/en/apps/prefab)** — charts, tables, dashboards, reactive state, with live demos
- **[FastMCPApp](/en/apps/fastmcp-app)** — when the UI needs to call back to your server (forms, search, CRUD)
