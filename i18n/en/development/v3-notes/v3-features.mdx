...
Documentation: [CLI Querying](/en/cli/client)
...
Documentation: [CIMD Authentication](/en/clients/auth/cimd), [OAuth Proxy CIMD config](/en/servers/auth/oauth-proxy#cimd-support)
...
Documentation: [Pre-Registered Clients](/en/clients/auth/oauth#pre-registered-clients)
...
Documentation: [Generate CLI](/en/cli/generate-cli)
...
Also adds a full integration guide at [Goose Integration](/en/integrations/goose).
...
Documentation: [Middleware](/en/servers/middleware)
...
Documentation: [FileSystemProvider](/en/servers/providers/filesystem)
...
Documentation: [Skills Provider](/en/servers/providers/skills)
...
Documentation: [Telemetry](/en/servers/telemetry)
...
Documentation: [Pagination](/en/servers/pagination)
...
Documentation: [Lifespan](/en/servers/lifespan)
