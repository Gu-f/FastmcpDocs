...
<Note>
If the client doesn't provide a sampling handler, servers can optionally configure a fallback handler. See [Server Sampling](/en/v2/servers/sampling#sampling-fallback-handler) for details.
</Note>
