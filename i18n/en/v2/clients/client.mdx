...
See [Tools](/en/v2/clients/tools) for detailed documentation.
...
See [Resources](/en/v2/clients/resources) for detailed documentation.
...
See [Prompts](/en/v2/clients/prompts) for detailed documentation.
...
For detailed transport configuration (headers, authentication, environment variables), see the [Transports](/en/v2/clients/transports) documentation.
...
### Core Operations
- **[Tools](/en/v2/clients/tools)** - Execute server-side functions and handle results
- **[Resources](/en/v2/clients/resources)** - Access static and templated resources  
- **[Prompts](/en/v2/clients/prompts)** - Work with message templates and argument serialization

### Advanced Features
- **[Logging](/en/v2/clients/logging)** - Handle server log messages
- **[Progress](/en/v2/clients/progress)** - Monitor long-running operations
- **[Sampling](/en/v2/clients/sampling)** - Respond to server LLM requests
- **[Roots](/en/v2/clients/roots)** - Provide local context to servers

### Connection Details
- **[Transports](/en/v2/clients/transports)** - Configure connection methods and parameters
- **[Authentication](/en/v2/clients/auth/oauth)** - Set up OAuth and bearer token authentication
