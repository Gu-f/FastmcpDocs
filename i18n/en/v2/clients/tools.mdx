...
The structure and usage of `meta` is determined by your application. See [Client Metadata](/en/v2/servers/context#client-metadata) in the server documentation to learn how to access this data in your tool implementations.
