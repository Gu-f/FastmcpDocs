...
- **Sampling requests**: Use [`sampling_handler`](/en/v2/clients/sampling)
- **Progress requests**: Use [`progress_handler`](/en/v2/clients/progress)  
- **Log requests**: Use [`log_handler`](/en/v2/clients/logging)
