...
Ready to build? Start with our [installation guide](/en/v2/getting-started/installation) or jump straight to the [quickstart](/en/v2/getting-started/quickstart).
