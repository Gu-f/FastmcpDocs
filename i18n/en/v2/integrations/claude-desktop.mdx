...
import { LocalFocusTip } from "/en/snippets/local-focus.mdx"
...
For authenticated remote servers, create an authenticated client following the guidance in the [client auth documentation](/en/v2/clients/auth/bearer) and pass it to the proxy:
