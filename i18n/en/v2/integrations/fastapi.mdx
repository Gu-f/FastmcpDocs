...
<Tip>
To learn more about customizing the conversion process, see the [OpenAPI Integration guide](/en/v2/integrations/openapi).
</Tip>
...
If you're mounting an authenticated MCP server under a path prefix, see [Mounting Authenticated Servers](/en/v2/deployment/http#mounting-authenticated-servers) for important OAuth routing considerations.
...
For more details on configuration options, see the [OpenAPI Integration guide](/en/v2/integrations/openapi).