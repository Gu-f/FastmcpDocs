...
Every new feature needs tests. See the [Testing Guide](/en/v2/development/tests) for patterns and requirements.
...
**Breaking Changes**: May be acceptable in minor versions but must be clearly documented. See the [versioning policy](/en/v2/development/releases#versioning-policy).
