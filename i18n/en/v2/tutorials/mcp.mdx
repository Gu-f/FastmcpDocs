...
[**Learn more about Tools →**](/en/v2/servers/tools)
...
[**Learn more about Resources & Templates →**](/en/v2/servers/resources)
...
[**Learn more about Prompts →**](/en/v2/servers/prompts)
...
[**Tutorial: How to Create an MCP Server in Python →**](/en/v2/tutorials/create-mcp-server)
