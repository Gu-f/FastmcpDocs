...
<Tip>
Learn more about working with OpenAPI specs in the [OpenAPI integration docs](/en/v2/integrations/openapi).
</Tip>
...
<Tip>
Learn more about the FastMCP client in the [client docs](/en/v2/clients/client).
</Tip>
...
<Tip>
Learn more about route maps in the [OpenAPI integration docs](/en/v2/integrations/openapi#route-mapping).
</Tip>
