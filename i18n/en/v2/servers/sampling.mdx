...
FastMCP provides built-in handlers for [OpenAI and Anthropic APIs](/en/v2/clients/sampling#built-in-handlers). These handlers support the full sampling API including tools, automatically converting your Python functions to each provider's format.
