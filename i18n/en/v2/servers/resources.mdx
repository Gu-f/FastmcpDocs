...
<ParamField body="icons" type="list[Icon] | None">
  ...
  Optional list of icon representations for this resource or template. See [Icons](/en/v2/servers/icons) for detailed examples
</ParamField>
...
Clients can handle these notifications using a [message handler](/en/v2/clients/messages) to automatically refresh their resource lists or update their interfaces.
