...
import { YouTubeEmbed } from '/en/snippets/youtube-embed.mdx'
...
- [Contrib Modules](/en/v2/patterns/contrib) - Community-contributed modules that are distributed with FastMCP itself