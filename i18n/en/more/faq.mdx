...
This can happen when you upgrade to FastMCP 3.3 or later from FastMCP 3.2 or earlier with `pip`. The quick fix is `pip install --force-reinstall fastmcp`. See [Troubleshooting](/en/getting-started/installation#troubleshooting) for the clean-reinstall fallback and an explanation of why it happens.
