...
- **Sampling requests**: Use [`sampling_handler`](/en/clients/sampling)
- **Elicitation requests**: Use [`elicitation_handler`](/en/clients/elicitation)
- **Progress updates**: Use [`progress_handler`](/en/clients/progress)
- **Log messages**: Use [`log_handler`](/en/clients/logging)
