...
See [Transports](/en/clients/transports) for detailed configuration options including authentication headers, session persistence, and multi-server configurations.
...
See [Tools](/en/clients/tools) for detailed documentation including version selection, error handling, and structured output.
...
See [Resources](/en/clients/resources) for detailed documentation including templates and binary content.
...
See [Prompts](/en/clients/prompts) for detailed documentation including argument serialization.
...
- **[Sampling](/en/clients/sampling)** - Respond to server LLM requests
- **[Elicitation](/en/clients/elicitation)** - Handle server requests for user input
- **[Progress](/en/clients/progress)** - Monitor long-running operations
- **[Logging](/en/clients/logging)** - Handle server log messages
- **[Roots](/en/clients/roots)** - Provide local context to servers
