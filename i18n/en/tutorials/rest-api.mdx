...
Make sure you have FastMCP installed. If not, follow the [installation guide](/en/getting-started/installation).
...
<Tip>
Learn more about working with OpenAPI specs in the [OpenAPI integration docs](/en/integrations/openapi).
</Tip>
...
<Tip>
Learn more about the FastMCP client in the [client docs](/en/clients/client).
</Tip>
...
<Tip>
Learn more about route maps in the [OpenAPI integration docs](/en/integrations/openapi#route-mapping).
</Tip>
