...
<CardGroup cols={3}>
  <Card title="Servers" img="/assets/images/servers-card.png" href="/en/servers/server">
    Expose tools, resources, and prompts to LLMs.
  </Card>
  <Card title="Apps" img="/assets/images/apps-card.png" href="/en/apps/overview">
    Give your tools interactive UIs rendered directly in the conversation.
  </Card>
  <Card title="Clients" img="/assets/images/clients-card.png" href="/en/clients/client">
    Connect to any MCP server — local or remote, programmatic or CLI.
  </Card>
</CardGroup>

**[Servers](/en/servers/server)** wrap your Python functions into MCP-compliant tools, resources, and prompts. **[Clients](/en/clients/client)** connect to any server with full protocol support. And **[Apps](/en/apps/overview)** give your tools interactive UIs rendered directly in the conversation.

Ready to build? Start with the [installation guide](/en/getting-started/installation) or jump straight to the [quickstart](/en/getting-started/quickstart).
