...
If you haven't already installed FastMCP, follow the [installation instructions](/en/getting-started/installation).
...
You can preview app tools locally with `fastmcp dev apps my_server.py` — no MCP host required. See the [Apps overview](/en/apps/overview) for the full guide, including state management, forms, charts, and server-connected interactivity.
...
For more details, see the [Prefect Horizon guide](/en/deployment/prefect-horizon).
