---
title: 常见问题
description: 关于安装和使用 FastMCP 的常见问题解答
icon: circle-question
---

## 使用 pip 升级后，`import fastmcp` 无法工作

当你使用 `pip` 从 FastMCP 3.2 或更早版本升级到 FastMCP 3.3 或更高版本时，可能会发生这种情况。快速修复方法是运行 `pip install --force-reinstall fastmcp`。请参阅[故障排除](/zh/getting-started/installation#故障排除)，了解干净重装的备用方案以及问题原因说明。
