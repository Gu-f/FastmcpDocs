...
有关身份认证 headers、会话持久化和多服务端配置等详细配置选项，请参阅[传输](/zh/clients/transports)。
...
有关版本选择、错误处理和结构化输出等详细文档，请参阅[工具](/zh/clients/tools)。
...
有关模板和二进制内容等详细文档，请参阅[资源](/zh/clients/resources)。
...
有关参数序列化等详细文档，请参阅[提示词](/zh/clients/prompts)。
...
- **[采样](/zh/clients/sampling)** - 响应服务端的 LLM 请求
- **[用户征询](/zh/clients/elicitation)** - 处理服务端对用户输入的请求
- **[进度](/zh/clients/progress)** - 监控长时间运行的操作
- **[日志](/zh/clients/logging)** - 处理服务端日志消息
- **[Roots](/zh/clients/roots)** - 向服务端提供本地上下文
