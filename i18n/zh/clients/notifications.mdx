...
title: 通知
sidebarTitle: 通知
description: 处理服务端发送的列表变更和其他事件通知。
icon: envelope
---
...
- **用户征询请求**：使用 [`elicitation_handler`](/zh/clients/elicitation)
- **进度更新**：使用 [`progress_handler`](/zh/clients/progress)
- **日志消息**：使用 [`log_handler`](/zh/clients/logging)
