---
title: "Contrib 模块"
description: "扩展 FastMCP 的社区贡献模块"
icon: "cubes"
---
...
可用模块可以在 [contrib 目录](https://github.com/PrefectHQ/fastmcp/tree/main/fastmcp_slim/fastmcp/contrib)中查看。
...
1. 在 `fastmcp_slim/fastmcp/contrib/` 中为你的模块创建新目录
3. 在 `tests/contrib/` 中为你的模块添加适当测试
2. 在 README.md 文件中包含完整文档，包括用法和示例，以及任何额外依赖或安装说明
5. 提交 pull request
