...
See the [MCPConfigTransport](/zh/v2/clients/transports#工具转换) documentation for more details.
...
This is one of the most common reasons to use tool transformation. Tools from remote MCP servers (via a [proxy](/zh/v2/servers/proxy)) or generated from an [OpenAPI spec](/zh/v2/integrations/openapi) are often too generic for direct use by an LLM. You can use transformation to create a simpler, more intuitive version for your specific needs.
