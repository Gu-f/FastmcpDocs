...
<ParamField body="enabled" type="bool" default="True">
  启用或禁用资源的布尔值。更多信息请参阅[禁用资源](#禁用资源)
</ParamField>

<ParamField body="icons" type="list[Icon] | None">
  <VersionBadge version="2.14.0" />

  此资源或模板的可选图标表示列表。详细示例请参阅[图标](/zh/v2/servers/icons)
</ParamField>
...
有关 Context 对象及其所有功能的完整文档，请参阅[上下文文档](/zh/v2/servers/context)。
...
客户端可以使用[消息处理程序](/zh/v2/clients/messages)处理这些通知，以自动刷新其资源列表或更新其界面。
