...
<Tip>
在 [OpenAPI 集成文档](/zh/v2/integrations/openapi) 中了解更多关于使用 OpenAPI 规范的信息。
</Tip>
...
<Tip>
在[客户端文档](/zh/v2/clients/client)中了解更多关于 FastMCP 客户端的信息。
</Tip>
...
<Tip>
在 [OpenAPI 集成文档](/zh/v2/integrations/openapi#路由映射) 中了解更多关于路由映射的信息。
</Tip>
