...
本指南展示如何使用 [**Descope**](https://www.descope.com) 保护你的 FastMCP 服务端。Descope 是完整的身份认证和用户管理解决方案。该集成使用 [**Remote OAuth**](/zh/v2/servers/auth/remote-oauth) 模式，由 Descope 处理用户登录，而你的 FastMCP 服务端负责验证令牌。
