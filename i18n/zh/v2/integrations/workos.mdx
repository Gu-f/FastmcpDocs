...
<Note>
本指南涵盖 WorkOS Connect 应用程序。对于使用 AuthKit 的动态客户端注册 (DCR)，请参阅 [AuthKit 集成](/zh/v2/integrations/authkit)。
</Note>
...
<ParamField path="FASTMCP_SERVER_AUTH_WORKOS_ISSUER_URL" default="使用 BASE_URL">
