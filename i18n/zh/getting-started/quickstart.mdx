...
If you haven't already installed FastMCP, follow the [installation instructions](/zh/getting-started/installation).
...
For more details, see the [FastMCP Cloud guide](/zh/deployment/fastmcp-cloud).