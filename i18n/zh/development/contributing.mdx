...
Every new feature needs tests. See the [Testing Guide](/zh/development/tests) for patterns and requirements.
...
**Breaking Changes**: May be acceptable in minor versions but must be clearly documented. See the [versioning policy](/zh/development/releases#versioning-policy).
