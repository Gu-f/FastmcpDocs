...
<ParamField body="issuer_url" type="AnyHttpUrl | str | None">
  ...
  **何时使用：**
  ...
  有关完整的挂载示例，请参阅 [HTTP 部署指南](/zh/deployment/http#挂载已认证服务器)。
</ParamField>
...
<VersionBadge version="2.13.0" />
  ...
  **对于生产环境：**
  ...
  有关完整的生产设置，请参阅 [HTTP 部署 - OAuth 令牌安全](/zh/deployment/http#oauth-令牌安全性)。
</ParamField>
