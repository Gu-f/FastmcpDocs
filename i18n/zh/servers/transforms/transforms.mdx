...
- **[命名空间](/zh/servers/transforms/namespace)** - 为组件名称添加前缀，避免组合服务端时发生冲突
- **[工具转换](/zh/servers/transforms/tool-transformation)** - 重命名工具、修改描述、重塑参数
- **[启用状态](/zh/servers/visibility)** - 在运行时控制哪些组件可见
- **[工具搜索](/zh/servers/transforms/tool-search)** - 用按需搜索替代大型工具目录
- **[资源作为工具](/zh/servers/transforms/resources-as-tools)** - 向仅支持工具的客户端暴露资源
- **[提示词作为工具](/zh/servers/transforms/prompts-as-tools)** - 向仅支持工具的客户端暴露提示词
- **[代码模式（实验性）](/zh/servers/transforms/code-mode)** - 用可编程的 `search` + `execute` 替代大量工具
