...
<Frame>
  <img src="/apps/images/app-approval.png" alt="Goose 中显示的 Approval provider，包含付款确认卡片和批准/取消按钮" />
</Frame>
...
1. `SendMessage` 将决策作为用户消息推送到对话中
2. `SetState("decided", True)` 将按钮替换为 "Response sent."
